...
def test_engine(py_func, marginal_for_startup_rank):
    ...
    in_dict = dict(  # noqa: C408
        ...
        storage_charge_mw=np.array([400, 200]),
        storage_hrs=np.array([4, 12]),
        storage_charge_eff=np.array((0.9, 0.9)),
        storage_discharge_eff=np.array((1.0, 1.0)),
...
def test_dispatch_engine_auto(py_func, coeff, reserve, marginal_for_startup_rank):
    ...
    in_dict = dict(  # noqa: C408
        ...
        storage_charge_mw=np.array([400, 200], dtype=float),
        storage_hrs=np.array([4, 12], dtype=float),
        storage_charge_eff=np.array((0.9, 0.9), dtype=float),
        storage_discharge_eff=np.array((1.0, 1.0), dtype=float),
        storage_op_hour=np.array((0, 0)),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"desired_mw": 1, "state_of_charge": 2, "mw": 3, "max_state_of_charge": 6, "eff": 0.5}, 1),
        ({"desired_mw": 1, "state_of_charge": 5, "mw": 3, "max_state_of_charge": 6, "eff": 0.5}, 1),
        ({"desired_mw": 5, "state_of_charge": 2, "mw": 3, "max_state_of_charge": 6, "eff": 0.5}, 1),
        ({"desired_mw": 9, "state_of_charge": 5, "mw": 3, "max_state_of_charge": 6, "eff": 0.5}, 2.5),

        ({"desired_mw": 1, "state_of_charge": 2, "mw": 3, "max_state_of_charge": 6, "reserve": 0.5, "eff": 0.5}, 0),
        ({"desired_mw": 1, "state_of_charge": 5, "mw": 3, "max_state_of_charge": 6, "reserve": 0.5, "eff": 0.5}, 1),
        ({"desired_mw": 5, "state_of_charge": 2, "mw": 3, "max_state_of_charge": 6, "reserve": 0.5, "eff": 0.5}, 0),
        ({"desired_mw": 9, "state_of_charge": 5, "mw": 3, "max_state_of_charge": 6, "reserve": 0.5, "eff": 0.5}, 1),
    ],
    ids=idfn,
)
